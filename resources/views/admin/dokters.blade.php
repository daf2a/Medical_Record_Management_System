                    ...
                    <div class="flex items-center">
                        ...
                        <div class="hidden sm:flex sm:items-center">
                            <x-dropdown align="left" width="24">
                                ...
                                <x-slot name="content">
                                    <form action="{{ route('dokters.list') }}" method="get">
